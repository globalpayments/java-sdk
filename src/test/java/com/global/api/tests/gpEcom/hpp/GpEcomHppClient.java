package com.global.api.tests.gpEcom.hpp;
...
public class GpEcomHppClient {
    ...
    public GpEcomHppClient(String url, String sharedSecret) {
        this.serviceUrl = url;
        this.sharedSecret = sharedSecret;
        this.shaHashType = ShaHashType.SHA1;
    }

    public GpEcomHppClient(String url, String sharedSecret, ShaHashType shaHashType) {
        this.serviceUrl = url;
        this.sharedSecret = sharedSecret;
