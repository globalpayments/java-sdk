...
public class VapsVoyagerFleetTestsCert {
    ...
    public VapsVoyagerFleetTestsCert() throws ApiException {
    ...
    @Test
    public void test_001_VoyagerSwipe_authorization() throws ApiException {
        track = TestCards.VoyagerSwipe();
    ...
    @Test
    public void test_001_VoyagerSwipe_auth_capture() throws ApiException {
        track = TestCards.VoyagerSwipe();
    ...
    @Test
    public void test_001_VoyagerSwipe_auth_capture_Retransmit() throws ApiException {
        track = TestCards.VoyagerSwipe();
        ...
        productData.addNonFuel("91", UnitOfMeasure.Liters, new BigDecimal("10"), new BigDecimal(22), new BigDecimal(5));
        productData.addNonFuel("58", UnitOfMeasure.OtherOrUnknown, new BigDecimal("11"), new BigDecimal(50), new BigDecimal(10));
    ...
    @Test
    public void test_003_swipe_refund_creditAdjust_retransmit() throws ApiException {
        Transaction response = track.charge(new BigDecimal("10"))
                .withCurrency("USD")
                .withFleetData(fleetData)
                .withProductData(productData)
        ...
        productData.addFuel(ProductCode.SUPER_UNLEADED_ETHANOL, UnitOfMeasure.Units, new BigDecimal("20.12"), new BigDecimal("30.00"), new BigDecimal("50.2"));
