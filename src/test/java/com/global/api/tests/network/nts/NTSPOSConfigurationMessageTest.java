...
import com.global.api.network.entities.nts.NtsPOSSiteConfigurationData;
...
public class NTSPOSConfigurationMessageTest {
    ...
    public void test_POS_site_configuration() throws ApiException {
        ...
        NtsPOSSiteConfigurationData posSiteConfiguration = new NtsPOSSiteConfigurationData();
        ...
        posSiteConfiguration.setHeartlandNtsTerminalSpecVersion("0212");
        ...
        Transaction response = NetworkService.sendSiteConfiguration()
                ...
                .withNtsPOSSiteConfigData(posSiteConfiguration)
                .execute();
