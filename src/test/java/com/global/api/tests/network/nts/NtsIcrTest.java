...
//        track.setCardType("Amex");
    ...
    public void test_WexFleet_auth_001_Manual() throws  ApiException {
        ...
        //productData.addFuel(ProductCode.Unleaded_Gas, UnitOfMeasure.Gallons,new BigDecimal(0),new BigDecimal(0),new BigDecimal(10));
    ...
    @Test //Not working
    public void test_WexFleet_auth_002_Track2() throws ApiException, ApiException {
    ...
    public void test_WexFleet_auth_002_track2_EMV() throws ApiException {
        ...
        NtsProductData productData = getProductDataForNonFleetBankCards(track);
        //productData.addFuel(ProductCode.Miscellaneous, UnitOfMeasure.Gallons,new BigDecimal(0),new BigDecimal(0),new BigDecimal(10));
