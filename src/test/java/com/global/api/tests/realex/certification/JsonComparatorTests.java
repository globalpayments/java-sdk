package com.global.api.tests.realex.certification;
...
public class JsonComparatorTests {
    ...
    public void compareSameStrings() {
        assertEquals(true, JsonComparator.areEqual(KNOWN_GOOD_JSON, KNOWN_GOOD_JSON));
    }
    ...
    public void compareWithMissingField() {
        ...
        assertEquals(false, JsonComparator.areEqual(KNOWN_GOOD_JSON, testString));
    }
