...
public class PorticoCreditTests {
    ...
    public void creditSwipeSale() throws ApiException {
        String clientTxnID = ciTestingHarness.generateRandomId("creditSwipeSale");
    ...
    public void creditSwipeRefund() throws ApiException {
        String clientTxnID = ciTestingHarness.generateRandomId("creditSwipeRefund");
    ...
    public void creditSwipeReverse() throws ApiException {
        String clientTxnID = ciTestingHarness.generateRandomId("creditSwipeReverse");
    ...
    public void creditReversalFromClientTransactionId() throws ApiException {
        String clientTxnID = ciTestingHarness.generateRandomId("creditReversalFromClientTransactionId");
        Transaction response = card.authorize(new BigDecimal(10))
                .withCurrency("USD")
                .withAllowDuplicates(true)
                .withClientTransactionId(clientTxnID)
    ...
    public void creditSale_withSAFIndicator_And_SAFOrigDT_01() throws ApiException {
        Transaction response = card.charge(new BigDecimal(15))
                ...
                .withSAFOrigDT(ciTestingHarness.getCurrentTime().toString())
                .execute();
        assertNotNull(response);
        assertEquals("00", response.getResponseCode());
    }
    ...
    public void creditAuthorization_withoutSAFIndicator03() throws ApiException {
        String clientTxnID = ciTestingHarness.generateRandomId("creditAuthorization_withoutSAFIndicator03");
        Transaction response = card.authorize(new BigDecimal(14))
                .withClientTransactionId(clientTxnID)
                .withCurrency("USD")
                .withAllowDuplicates(true)
    ...
    public void creditSale_ClerkId() throws ApiException {
        String clientTxnID = ciTestingHarness.generateRandomId("creditSale_ClerkId");
        Transaction response = card.charge(new BigDecimal(15))
                .withCurrency("USD")
                .withClientTransactionId(clientTxnID)
                .withAllowDuplicates(true)
    ...
    @Test
    public void credit_Sale_AmountIndicator_Null() throws ApiException {
        Transaction response = card.charge(new BigDecimal(10))
                .withCurrency("USD")
                .withAllowDuplicates(true)
                .execute();
