...
public interface IAccessTokenProvider {
    GpApiRequest signIn(String appId, String appKey, int secondsToExpire, IntervalToExpire intervalToExpire, String[] permissions, RestrictedTokenType restrictedToken, PorticoTokenConfig porticoTokenConfig) throws GatewayException;
