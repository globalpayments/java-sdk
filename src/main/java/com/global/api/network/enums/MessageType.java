...
public enum MessageType implements IByteConstant {
    ...
    // 0x84 (0x20),
    DEPS_8583 (0x21),
    GlobalPayments_8583 (0x22),
    GlobalPayments_POS_8583 (0x23),
    BIC_ISO (0x24),
    GlobalPayments_NTS (0x25),
    ATT_Format_III (0x26),
    ATT_Format_IV (0x27),
    CPNI (0x28),
    GlobalPayments_Prepaid_XML (0x29),
    GlobalPayments_Prepaid_Host_to_Host (0x2A),
    NPC_Processing (0x30),
