    ...
    public byte[] toByteArray() {
        ...
        if (posData != null){
            ...
            String posConfigData = StringUtils.padRight(posData.getMessageVersion(),3,'0')
                    ...
                    .concat(StringUtils.padLeft(posData.getGlobalPaymentsCompanyId(),5,' '))
                    ...
                    .concat(StringUtils.padLeft(posData.getGlobalPaymentsPosTerminalType(),3,' '))
                    .concat(StringUtils.padLeft(posData.getGlobalPaymentsPosSoftwareVersion(),8,' '))
                    .concat(StringUtils.padLeft(posData.getGlobalPaymentsTerminalSpec(),1,' '))
                    .concat(StringUtils.padLeft(posData.getGlobalPaymentsTerminalSpecVersion(),4,' '))
                    .concat(StringUtils.padLeft(posData.getGlobalPaymentsPaymentEngine(),1,' '))
                    .concat(StringUtils.padLeft(posData.getGlobalPaymentsPaymentVertical(),1,' '))
                    ...
                    .concat(StringUtils.padLeft(posData.getGlobalPaymentsPrimaryDialNumberOrIpPort(),21,' '))
                    .concat(StringUtils.padLeft(posData.getGlobalPaymentsSecondaryDialNumberOrIpPort(),21,' '))
