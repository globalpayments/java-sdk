...
public class SipSAFResponse extends SipBaseResponse implements ISAFResponse {
    ...
    public SipSAFResponse(byte[] buffer, String... messageIds) throws ApiException {
    ...
    protected void mapResponse(Element response) {
        ...
        if(category.endsWith("SUMMARY")) {
            ...
            if(fieldValues.containsKey("TransactionTime")) {
                trans.setTransactionDate(fieldValues.getDate("TransactionTime"));
            }
